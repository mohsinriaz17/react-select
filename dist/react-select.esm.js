...
var Input = function Input(_ref2) {
  var className = _ref2.className,
      ...
      theme = _ref2.theme,
      props = objectWithoutProperties(_ref2, ['className', 'cx', 'getStyles', 'innerRef', 'isHidden', 'isDisabled', 'isRequired', 'theme']);
  return React.createElement(
    'div',
    {
...
var Select = function (_Component) {
  ...
  createClass(Select, [{
    ...
    value: function renderPlaceholderOrValue() {
      ...
      return React.createElement(
        SingleValue,
        _extends({}, commonProps, { data: singleValue, isDisabled: isDisabled, isRequired: isRequired }),
    ...
    value: function render() {
      ...
      var _props13 = this.props,
          ...
          isRequired = _props13.isRequired;
      var isFocused = this.state.isFocused;
